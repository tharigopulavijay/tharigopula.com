...
INSERT INTO "sessions" ("token_hash","doctor_id","created_at","expires_at","user_agent","revoked_at","user_id") VALUES('09869e5b35ea7d206bf2850f37454b8a018aa2ff2b635c562e35b1d201ce8986','doc_demo','2026-09-08 19:16:27','2026-09-09T07:16:27.163Z','Mozilla/5.0 (Windows NT 10.0; Microsoft Windows 10.0.26200; en-IN) PowerShell/7.6.5',NULL,NULL);
...
INSERT INTO "audit_events" ("id","doctor_id","actor","action","target_type","target_id","detail","ip","created_at","actor_user_id") VALUES('aud_f57a53ccc01b4f39bd20a6ea','doc_demo','doctor:doc_demo','sign_in',NULL,NULL,NULL,NULL,'2026-09-08 19:16:27',NULL);
...
INSERT INTO "d1_migrations" ("id","name","applied_at") VALUES(46,'046-auth-throttles.sql','2026-09-08 19:14:31');
...
INSERT INTO "auth_throttles" ("scope","key_hash","failures","window_started_at","blocked_until","updated_at") VALUES('clinic_signin','47f0a09a5e4a966fd9cd3353ed4003a89f531f05ae13634a7a093520a4778e94',5,'2026-09-08T19:16:44.652Z','2026-09-08T19:21:48.738Z','2026-09-08T19:16:48.738Z');
DELETE FROM sqlite_sequence;
INSERT INTO "sqlite_sequence" ("name","seq") VALUES('d1_migrations',46);
...
CREATE UNIQUE INDEX idx_prescriptions_idempotency
  ...
  WHERE idempotency_key IS NOT NULL;
CREATE INDEX idx_auth_throttles_updated
