...
const STATIC_ROUTES = [
  ...
  { path: "/live-demos", priority: "0.9", changefreq: "monthly" },
  { path: "/live-demos/mobile-apps", priority: "0.8", changefreq: "monthly" },
  { path: "/live-demos/websites", priority: "0.8", changefreq: "monthly" },
  { path: "/live-demos/business-software", priority: "0.8", changefreq: "monthly" },
  { path: "/live-demos/automation", priority: "0.8", changefreq: "monthly" },
  { path: "/experience-lab", priority: "0.7", changefreq: "monthly" },
