...
const STATIC_ROUTES = [
  ...
  { path: "/showcase", priority: "0.9", changefreq: "monthly" },
  { path: "/showcase/websites", priority: "0.9", changefreq: "monthly" },
  { path: "/showcase/mobile-apps", priority: "0.8", changefreq: "monthly" },
  { path: "/showcase/business-software", priority: "0.8", changefreq: "monthly" },
  { path: "/showcase/dashboards", priority: "0.8", changefreq: "monthly" },
  { path: "/showcase/automation", priority: "0.8", changefreq: "monthly" },
...
try {
  ...
  const entries = [
    ...
    ...templates.map((t) => ({
      path: `/showcase/templates/${t.slug}`,
      priority: "0.7",
      changefreq: "monthly",
    })),
  ];
