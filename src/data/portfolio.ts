...
export const caseStudies: CaseStudy[] = [
  {
    ...
    architecture: [
      { layer: "Data", detail: "Relational database with customer, product, order, stock, job-card and warranty entities." },
      { layer: "Application", detail: "Role-based web application for sales, stores, service and management." },
      { layer: "Automation", detail: "Scheduled reminders, low-stock alerts and daily management summary." },
      { layer: "Analytics", detail: "Live dashboards over the same database, no separate reporting file." },
    ],
    features: ["CRM", "Order management", "Inventory", "Production tracking", "Service management", "Warranty tracking", "Job cards", "Role-based access", "Dashboards", "Alerts"],
    screens: ["Sales pipeline", "Order & dispatch", "Stock ledger", "Job card", "Warranty lookup", "Management dashboard"],
    automation: ["Follow-up reminders on stale leads", "Low-stock alerts to stores", "Job-card status updates to customers", "Daily summary to management"],
    analytics: ["Sales by product and region", "Order-to-dispatch time", "Stock ageing", "Service load and repeat failures", "Warranty cost exposure"],
    outcome: [
    ...
    future: ["Dealer portal", "Production scheduling", "Predictive service intervals", "Mobile app for field engineers"],
  ...
  },
  {
    ...
    summary: "A professional clinic website joined to appointment handling and automated patient reminders.",
    challenge: [
    ...
    features: ["Clinic website", "Online appointments", "Reception dashboard", "Patient records", "Reminders", "Reporting"],
    screens: ["Home", "Doctor profile", "Booking flow", "Reception queue", "Daily schedule"],
    automation: ["Appointment confirmation", "Day-before reminder", "Post-visit follow-up", "Missed-appointment nudge"],
    analytics: ["Appointments per doctor", "No-show rate", "Enquiry source", "Peak-hour load"],
    outcome: ["Fewer repeat phone calls", "Bookings possible outside clinic hours", "Reminders sent without staff effort", "Clear daily schedule for each doctor"],
    future: ["Patient login with history", "Digital prescriptions", "Payment collection", "Teleconsultation"],
  ...
  },
  {
    ...
    summary: "Turned anonymous walk-in footfall into a customer database with measurable repeat visits.",
    challenge: [
    ...
    solution: ["QR capture at every table", "Loyalty tracking against phone number", "Segmented WhatsApp campaigns", "Menu and offers site", "Customer analytics"],
    architecture: [
    ...
    screens: ["QR capture", "Reward status", "Campaign builder", "Customer segments", "Manager dashboard"],
    automation: ["Welcome message", "Reward unlocked alert", "Win-back after inactivity", "Festival campaigns"],
    analytics: ["New vs repeat customers", "Visit frequency", "Campaign conversion", "Outlet comparison"],
    outcome: ["An owned customer database instead of aggregator dependence", "Campaigns targeted by behaviour", "Repeat visits measurable for the first time"],
    future: ["Table ordering", "Online payments", "Reservation management", "Franchise-level reporting"],
  ...
  },
  {
    ...
    summary: "A lead engine where customers self-qualify through calculators before a single call is made.",
    challenge: ["Leads lost between calls", "Customers did not understand product differences", "Documents collected over chat", "No structured follow-up"],
    understanding: [
    ...
    solution: ["Product education pages", "EMI and eligibility calculators", "Structured lead capture", "Lead pipeline with stages", "Automated follow-up sequences"],
    architecture: [
    ...
    features: ["Calculators", "Lead capture", "Lead management", "Document upload", "Follow-up automation", "Dashboards"],
    screens: ["Product page", "Calculator", "Application form", "Lead pipeline", "Agent dashboard"],
    automation: ["Instant acknowledgement", "Document reminder", "Stage-based follow-ups", "Idle-lead escalation"],
    analytics: ["Lead source quality", "Stage-wise drop-off", "Response time", "Conversion by product"],
    outcome: ["Better qualified enquiries", "No lead left without a next action", "Clear view of where deals stall"],
    future: ["Credit-check integration", "Digital KYC", "Customer portal", "Partner referral tracking"],
  ...
  },
  {
    ...
    summary: "A connected platform linking pet owners, doctors, appointments, prescriptions and services.",
    challenge: ["Records fragmented per clinic", "Appointments handled manually", "No prescription history for a pet", "No repeat engagement with owners"],
    understanding: ["The pet, not the visit, is the record that matters.", "Doctors needed history in seconds, not a search through registers."],
    solution: ["Pet-centric records", "Doctor portal", "Owner-facing booking", "Digital prescriptions", "Service catalogue and marketplace structure"],
    architecture: [
    ...
    features: ["Pet records", "Appointments", "Prescriptions", "Doctor portal", "Service marketplace", "Reminders"],
    ...
    outcome: ["Full history available at consultation", "Owners book without calling", "Reminders drive preventive visits"],
    future: ["Pharmacy & product ordering", "Home-visit scheduling", "Payments", "Multi-city expansion"],
  ...
  },
  {
    ...
    summary: "A credible online presence combined with simple field data capture and operational dashboards.",
    challenge: ["No online credibility with buyers", "Field records on paper", "Monitoring done by phone calls", "Cost per acre unknown"],
    understanding: ["Data entry had to work on a low-end phone with poor connectivity.", "Only a few numbers actually drive decisions."],
    solution: ["Business website", "Mobile-first field data capture", "Operations dashboard", "Automated reports"],
    architecture: [
    ...
    features: ["Website", "Field data capture", "Monitoring dashboard", "Scheduled reports", "Offline-tolerant entry"],
    ...
    outcome: ["Field records digital and searchable", "Weekly numbers without collection effort", "Buyers can verify the business online"],
