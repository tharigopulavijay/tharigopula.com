import { priceLabel, startingAt, tierById } from "./catalog";
...
export const websiteCategories: WebsiteCategory[] = [
  {
    ...
    priceFrom: startingAt(tierById("launch")),
    priceRange: priceLabel(tierById("launch")),
  ...
  },
  {
    ...
    priceFrom: startingAt(tierById("essential")),
    priceRange: priceLabel(tierById("essential")),
  ...
  },
  {
    ...
    priceFrom: startingAt(tierById("dynamic")),
    priceRange: priceLabel(tierById("dynamic")),
  },
  {
    ...
    priceFrom: startingAt(tierById("premium")),
    priceRange: priceLabel(tierById("premium")),
  },
  {
    slug: "cinematic",
    index: 5,
    ...
    priceFrom: startingAt(tierById("cinematic")),
    priceRange: priceLabel(tierById("cinematic")),
  ...
  },
  {
    ...
    priceFrom: startingAt(tierById("threed")),
    priceRange: priceLabel(tierById("threed")),
...
export const templates: Template[] = [
  ...
  },
  {
    ...
    recommendedFor:
      "Clinics and practitioners needing appointments and patient information online.",
  ...
  },
  {
    ...
    recommendedFor:
      "Lending, insurance and advisory businesses that must build trust and capture leads.",
