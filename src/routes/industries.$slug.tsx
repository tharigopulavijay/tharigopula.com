          ...
          {playbook ? (
            <div className="mt-8 flex flex-wrap items-center gap-x-8 gap-y-4 border-t border-ink-border pt-6">
              <div>
                ...
                <p className="mt-1 font-display text-xl font-semibold text-ink-foreground">
                  {playbook.startingFrom}
                </p>
              </div>
          ...
          <div>
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <Link
                ...
                className="rounded-md bg-ink px-5 py-3.5 text-sm font-semibold text-ink-foreground"
              >
              ...
              <Link
                to="/demo/platform"
                search={{ industry: industry.slug }}
                className="rounded-md border border-border px-5 py-3.5 text-sm font-semibold"
              >
        ...
        <>
            ...
            <ol className="mt-8 grid gap-px overflow-hidden rounded-xl border border-border bg-border sm:grid-cols-2">
              {playbook.automations.map((a) => (
                <li key={a.trigger} className="bg-card p-6">
                  ...
                  <p className="mt-4 font-mono text-[10px] tracking-[0.16em] text-signal uppercase">
                    Then, automatically
                  </p>
          ...
          <Section className="bg-secondary/40">
            ...
            <p className="mt-6 max-w-2xl text-sm text-muted-foreground">
              You do not need all of this on day one. Solve the immediate problem first, and add the
              rest as the business needs it.
            </p>
          </Section>
        </>
      ) : null}
      ...
      {related.length ? (
        <Section>
          <SectionHeading
            ...
            title={`What we have built for ${industry.name.toLowerCase()}`}
          />
