...
import { demoAssurances, demoCategories } from "@/data/showcase";
import { whatsappLink } from "@/data/site";

export const Route = createFileRoute("/showcase/")({
  head: () => ({
    meta: [
      { title: "Showcase — See What We Actually Build | Tharigopula Technologies" },
      {
        name: "description",
        content:
      ...
      { property: "og:title", content: "Showcase | Tharigopula Technologies" },
      {
      ...
      <section className="relative overflow-hidden border-b border-border bg-gradient-to-b from-secondary/50 to-background">
        <Container className="relative py-10 sm:py-12 lg:py-14">
          <nav aria-label="Breadcrumb" className="mb-8 text-sm text-muted-foreground">
            ...
            <span className="text-signal">Showcase</span>
          </nav>
